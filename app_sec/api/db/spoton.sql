...
-- INSERTS USERS
INSERT INTO `users` (`nome`, `email`, `pass`) VALUES ('admin', 'admin', MD5('admin'));
insert into `users` (`nome`,`email`,`pass`) values ('Lissi Nozzolii', 'lnozzolii0@examiner.com', MD5('4Mhm9xslPBO'));
insert into `users` (`nome`,`email`,`pass`) values ('Cherice Burds', 'cburds1@slate.com', MD5('6kFZ96fFBY'));
insert into `users` (`nome`,`email`,`pass`) values ('Murvyn Purkins', 'mpurkins2@eventbrite.com', MD5('bvipO5FUFeq2'));
insert into `users` (`nome`,`email`,`pass`) values ('Rianon Spraggs', 'rspraggs3@tripadvisor.com', MD5('7CAqw7V0oOe4'));
insert into `users` (`nome`,`email`,`pass`) values ('Karee Greim', 'kgreim4@feedburner.com', MD5('cuLOVdWG'));
insert into `users` (`nome`,`email`,`pass`) values ('Kriste Seefeldt', 'kseefeldt5@nyu.edu', MD5('zi7cDgVM'));
insert into `users` (`nome`,`email`,`pass`) values ('Waylan Slimon', 'wslimon6@sphinn.com', MD5('ePkufSE'));
